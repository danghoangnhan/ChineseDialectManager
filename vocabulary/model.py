...
class vocabulary(models.Model):
    ...
    tone = models.CharField(max_length=50, db_column='tone')
    symbol_text = models.CharField(max_length=50, db_column='symbol_text')
    dictionary_name = models.CharField(max_length=50, db_column='dictionary_name')
    ipa = models.CharField(max_length=50, db_column='ipa')
